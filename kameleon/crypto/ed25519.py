# https://raw.githubusercontent.com/pyca/ed25519/main/ed25519.py
...
def encodepoint(P):
    ...
    # by to prevent multiple malloc and oom due to memory fragmentation
    bits = [0]*b
    for i in range(b - 1):
        bits[i] = (y >> i) & 1
    bits[-1] = x & 1
